...
public class ProcessMemoryStream : Stream
{
    ...
    public override int Read(byte[] buffer, int offset, int count)
    {
        ...
        while (count > 0)
        {
            ...
            var didRead = NativeMethods.ReadProcessMemory(processHandle, (IntPtr)Position, readBuffer, blockSize, out numberOfBytesRead);
    ...
    public override int ReadByte()
    {
        ...
        var numberOfBytesRead = 0;
        var didRead = NativeMethods.ReadProcessMemory(processHandle, (IntPtr)Position, readBuffer, 1, out numberOfBytesRead);
    ...
    public override void Write(byte[] buffer, int offset, int count)
    {
        ...
        while (count > 0)
        {
            ...
            var didWrite = NativeMethods.WriteProcessMemory(processHandle, (IntPtr)Position, writeBuffer, blockSize, out numberOfBytesWritten);
    ...
    public override void WriteByte(byte value)
    {
        ...
        var numberOfBytesWritten = 0;
        var didWrite = NativeMethods.WriteProcessMemory(processHandle, (IntPtr)Position, writeBuffer, 1, out numberOfBytesWritten);
